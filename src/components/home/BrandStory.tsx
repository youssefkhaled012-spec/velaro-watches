      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 relative">
          <div className="relative aspect-[4/5] bg-[#0B0B0A] border border-[#2A2A26] p-3">
            <img
              ...
              alt="Valere Mechanical Watch Craftsmanship"
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <p className="font-sans text-sm text-[#8A8A85] leading-relaxed font-light">
            Founded in 1954, Valere Watches established its foundation on a singular conviction: that a timepiece is not merely an instrument for recording hours, but a living testament to human engineering and aesthetic passion.
          </p>
